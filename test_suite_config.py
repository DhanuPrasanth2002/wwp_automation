...
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(RepHqTerritoryConfigTests))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(businesssetconfigcustomer))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(businesssetconfigchemist))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(customerconfigmaster))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(chemistconfigmaster))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(billnameandstockistconfig))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(billcustomerandproductconfig))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(billchemistandproductconfig))
