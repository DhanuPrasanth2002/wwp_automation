...
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_payment_recommendation_customer))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_payment_recommendation_chemist))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_recommendation_tracking_customer))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_recommendation_tracking_chemist))
