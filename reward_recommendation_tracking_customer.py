...
config.read('reward_recommendation_tracking_customer.ini')

class reward_recommendation_tracking_customer(unittest.TestCase):
    ...
    def test_export_buttons(self):
        try:
            ...
            self.driver.get(config.get('DEFAULT', 'reward_recommendation_tracking_customer_url'))
    ...
    def test_edit_customer(self):
        try:
            ...
            amount_field = self.wait_and_find(config.get('DEFAULT', 'edit_amount_xpath'))
...
def run_all_tests():
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(reward_recommendation_tracking_customer)
...
if __name__ == "__main__":
    ...
    test_instance = reward_recommendation_tracking_customer()
    ...
    try:
        ...
        try:
            test_instance.test_readd_customer()
            passed_tests += 1
        except Exception as e:
            print(f"Test failed: test_readd_customer - {e}")
            failed_tests += 1
