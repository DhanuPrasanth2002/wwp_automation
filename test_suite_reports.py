...
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(saleslip))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(saleslipchemist))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(hqwisereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(chemisthqwisereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(businesssetreport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(chebusinesssetreport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(customerwiseandhqwisereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(chemistwiseandhqwisereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(monthwisesalesandhqwisereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(monthwisesalesandhqwisechereport))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(non_supporting_customer_list))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(non_supporting_chemist_list))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_distribution_customer))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(reward_distribution_chemist))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(complimentreportcustomer))
suite.addTests(unittest.TestLoader().loadTestsFromTestCase(complimentreportchemist))
